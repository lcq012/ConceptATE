...
class ACEProcessor():
    ...
    def convert_examples_to_features(self, tokenizer, examples, label_to_id, max_seq_length,args):
        ...
        rel_all_B=['is form of', 'is a', 'is synonym with', 'is derived from', 'is symbol of', 'have context with', 'is similar to']
        encodings = {}
        encodings["input_ids"] = []
...
# mycode_start  
            ...
            for k in range(context_len):
                ...
                for o in range(1,len_word_know):
            ...
            for word_idx in word_ids:
                ...
                # the label_all_tokens flag.
                    ...
                    real_len += 1
                    if word_idx == prefix and label[word_idx].startswith("B"):
                        label_ids.append(2)
                    else:
                        label_ids.append(label_to_id[label[word_idx]])
                prefix = word_idx
